...
const menuItems = [
  ...
  },
  {
    ...
    name: "Mocha",
    description: "Espresso with steamed chocolate and steamed milk",
    price: 5.4,
  },
  {
    imgSrc: "/assets/menu/coffee-1.png",
    name: "Macchiato",
    description: "Espresso with a dollop os foam",
    price: 3.75,
  },
  {
    imgSrc: "/assets/menu/coffee-2.png",
      ...
      <div className="container mx-auto">
        <div className="flex flex-col gap-4 mb-12 xl:mb-24">
          ...
          <p className="text-center max-w-[620px] mx-auto">
            ...
            aliquid ea sequi sit accusantium tempore exercitationem odio dolorum
            deleniti!
          </p>
        </div>
        {/* menu & btn */}
